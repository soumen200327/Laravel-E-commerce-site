...
function payment_status_change($id){
  ...
  if(check==true){
    ...
    window.location.href='/admin/payment_status_change/'+payment_status+'/'+$id;
  }
...
function order_status_change($id){
 ...
 // alert(payment_status+' '+$id);
  if(check==true){
    
    window.location.href='/admin/order_status_change/'+order_status+'/'+$id;
   }
  }