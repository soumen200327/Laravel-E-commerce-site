              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                    <label for="cod"><input type="radio" id="cod" value="COD" name="payment_type"> Cash on Delivery </label>
                   
                    <label for="instamojo"><input type="radio" id="instamojol" value="Gateway" name="payment_type" checked> Via Instamojo </label>
                   
                    <img src="{{ asset('admin_assets/images/icon/paypal.jpg') }}" border="0" alt="PayPal Acceptance Mark">    
                    
                    <input type="submit" id="PlaceOrder" class="aa-browse-btn">                
                  </div>
