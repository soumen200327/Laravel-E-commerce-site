            ...
            <aside class="aa-sidebar">
               ...
               <div class="aa-sidebar-widget">
                  ...
                  <ul class="aa-catg-nav">
                    ...
                    @foreach ($catacory_category as $item)
               ...
               <div class="aa-sidebar-widget">
                  ...
                  <div class="aa-color-tag">
                       @foreach ($catacory_color as $item)
                       <a class="aa-color-{{ strtolower($item->color) }}" href="javascript:void(0)" onclick="color_filter('{{$item->id}}')"></a> 
                       @endforeach
             </div>
               </div>
            </aside>
...
<input type="hidden" id="qty" value="1"/>
  ...
  <form id="categoryFilter">
    ...
    <input type="hidden" id="categoty_color" name="categoty_color" />
</form> 
@endsection