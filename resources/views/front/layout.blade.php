...
<head>
    ...
    <script>
        var PRODUCT_IMAGE = "{{ asset('storage/media/') }}"; // a ham na image ka path ko ak variabel ma store kar ka rakha
    </script>
                        ...
                        <div class="aa-header-bottom-area">
                            ...
                            <div class="aa-search-box">
                                <form action="">
                                    ...
                                    <button type="button" onclick="serach_product()"><span
            ...
            <div class="modal-content">
                ...
                <div id="Reg_form">
                    <div class="modal-body">
                        ...
                        <form class="aa-login-form" id="login_from">
                            @csrf
                            <label for=""> Email<span>*</span></label>
                            <input type="text" name="reg_email" placeholder="Username or email"
                                value="{{ $login_email }}">
                            ...
                            <button class="aa-browse-btn" name="login_btn" type="submit">Login</button>

                            <label for="rememberme" class="rememberme"><input type="checkbox" {{ $checkBox }}
                                    id="rememberme" name="rememberme"> Remember me </label>

                            <p class="aa-lost-password"><a href="#" onclick="for_get_password()">Lost your
                                    password?</a></p>
                            <div class="aa-register-now">
                                Don't have an account?<a href="{{ url('registation') }}">Register now!</a>
                            </div>

                        </form>
                        <div id="mag_login"> </div>
                    </div>
                </div>  
                    ...
                    <div id="forget_pwd" style="display: none;">
                        <div class="modal-body">
                            ...
                            <form class="aa-login-form" id="forget_from">
                                @csrf
                                <label for="">Email<span>*</span></label>
                                <input type="text" name="email_forget" placeholder=" Email" required>
                                <br>
                                <button class="aa-browse-btn" name="login_btn_forget" type="submit">Forget password</button>
                                <br>
                                <br>    
                                <div class="aa-register-now">
                                 
                                   Crate an account so<a href="javasctipt:void(0)" onclick="login_forget()"> Login now! </a>
                                </div>

                            </form>
                            <div id="mag_forget"> </div>
                        </div>
