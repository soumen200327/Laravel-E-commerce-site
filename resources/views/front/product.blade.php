                        ...
                        <div class="aa-product-details-content">
                            <div class="row">
                                ...
                                <a href="javascript:void(0)"
                                    class="aa-color-{{ strtolower($attr->color) }} product_color  link_hide  size_{{ $attr->size }}"
                                   id="color_{{$attr->color}}"  onclick=change_product_color_image("{{ asset('storage/media/' . $attr->attr_image) }}","{{ $attr->color }}")></a>
                                                @endif
                                            @endforeach
                                        </div>
                                            ...
                                            <figure>
                                                <a class="aa-product-img"
                                                    href="{{ url('product/' . $productArr->slug) }}"><img
                                                        ...
                                                        alt="{{ $productArr->name }}" height="300px" width="250px"></a>
