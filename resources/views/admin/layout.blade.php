            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    ...
                    <li class="@yield('dashboard_select')">
                        ...
                        <li class="@yield('order_detail')">
                            <a href="{{url('admin/order_detail')}}">
                            <i class="fa fa-first-order"></i>Order Detail</a>
                        </li>
                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><i class="zmdi zmdi-account zmdi-hc-2x m-r-10"></i>{{session('email')}}</a>
                                        </div>
